...
export default function ResellerRegister() {
  ...
  const validateStep = (step: number) => {
    switch (step) {
      ...
      case 2: // Store Setup
        // Allow domain setup to be optional
        if (formData.domainType === 'subdomain') {
          return formData.subdomainPrefix === '' || formData.subdomainPrefix.length >= 3;
        } else if (formData.domainType === 'customDomain') {
          return formData.customDomain === '' || 
                 /^([a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{2,}$/.test(formData.customDomain);
        }
        return true; // Both fields can be empty
      default:
        return false;
    }
  };
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-between pt-6 border-t">
              ...
              <Button type='button' onClick={handleCLOG}>
                  show
                </Button>
